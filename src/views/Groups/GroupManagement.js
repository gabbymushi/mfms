...
class GroupManagement extends Component {
    ...
    getGroups() {
        ...
        let uri = apiBaseUrl + '/get_groups/' + organization_id;
        axios.get(uri, {
            ...
            <div className="animated fadeIn">
                <Row>
                    <Col xl={12}>
                        <Card>
                            <CardHeader>
                                <i className="fa fa-align-justify"></i> Groups <small
                                    className="text-muted"></small>
                                <div className="card-header-actions">
                                    <Button color="primary" onClick={this.togglePrimary} className="mr-1">Add Group</Button>
                                </div>
                            </CardHeader>
                            <CardBody>
